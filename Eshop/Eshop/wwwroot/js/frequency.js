...
function loadDataTable() {
	dataTable = $('#tblData').DataTable({
		"ajax": {
			"url": "/admin/frequency/GetAllFrequencies",
			"type": "GET",
			"datatype": "json"
		},
		"columns": [
			...
			{ "data": "frequencyCount", "width": "20%" },
			{
                ...
                <div class="text-center">
                    ...
                    &nbsp;
                    <a onclick= Delete("/admin/frequency/DeleteFrequency/${data}") class="btn btn-danger text-white" style="cursor:pointer; width:100px;">
